...
import managment.modules.MainManagerModule;
...
public final class AGame extends Application {
    ...
    private final Injector injector = Guice.createInjector(new MainManagerModule(), new AGameModule(this));
    ...
    public final void start(Stage virtualStage) throws Exception {
        stageInitialization();
        aSceneMover.moveToScene(WindowType.INITIALIZATION);
    }
