...
public final class AccountBuilder {
    ...
    @NotNull
    @Contract(pure = true)
    static String directoryPath(final String name) {
        return "src\\profiles\\" + name;
    }

    @NotNull
    @Contract(pure = true)
    static String profilePath(final String name) {
        return directoryPath(name) + "\\" + name + ".hoa";
    }

    @NotNull
    @Contract(value = "_ -> !null", pure = true)
    static String collectionsPath(final String name) {
    ...
    @Contract(pure = true)
    @NotNull
    static List<String> createAccount(final String login, final String password) {
    ...
    @NotNull
    @Contract(pure = true)
    static String createDefaultDeck(final String name) {
